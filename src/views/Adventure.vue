     ...
     <v-row> 
        ...
        <v-row >
            <v-col align-self="align">
                ...
                <v-img
                v-bind:class="{reversed: this.cardSpread[0].reversed}" :src="require('../assets/cards/' + this.cardSpread[0].image)"> 
                 </v-img>
                
                 <v-card-title class="font-weight-black"> {{this.cardSpread[0].name}}  </v-card-title>
                 <v-card-title class="font-weight-black" v-if="this.cardSpread[0].reversed"> Reversed</v-card-title>
                 
                 <v-btn  depressed color="primary" @click="replaceCard(0)"> New Card </v-btn>
                </v-card>
            ...
            <v-col>
                ...
                <v-img v-bind:class="{reversed: this.cardSpread[1].reversed}" :src="require('../assets/cards/' + this.cardSpread[1].image)">  </v-img>
                <v-card-title class="font-weight-black"> {{this.cardSpread[1].name}}</v-card-title>
                <v-card-title class="font-weight-black" v-if="this.cardSpread[1].reversed"> Reversed</v-card-title>
                 
                 <v-btn  depressed color="primary" @click="replaceCard(1)" > New Card </v-btn>
                </v-card>
            ...
            <v-col >
                ...
                <v-img v-bind:class="{reversed: this.cardSpread[2].reversed}" :src="require('../assets/cards/' + this.cardSpread[2].image)">  </v-img>
                <v-card-title class="font-weight-black"> {{this.cardSpread[2].name}} </v-card-title>
                <v-card-title class="font-weight-black" v-if="this.cardSpread[2].reversed"> Reversed</v-card-title>

                 
                 <v-btn  depressed @click="replaceCard(2)" color="primary"> New Card </v-btn>
                </v-card>
            </v-col>
            ...
            <v-col >
                ...
                <v-img v-bind:class="{reversed: this.cardSpread[3].reversed}" :src="require('../assets/cards/' + this.cardSpread[3].image)">  </v-img>
                <v-card-title  class="font-weight-black" size =""> {{this.cardSpread[3].name}}</v-card-title>
                <v-card-title class="font-weight-black" v-if="this.cardSpread[3].reversed"> Reversed</v-card-title>
              

                 <v-btn  depressed @click="replaceCard(3)" color="primary"> New Card </v-btn>
                </v-card>
            </v-col>
            ...
            <v-col >
                ...
                <v-img v-bind:class="{reversed: this.cardSpread[4].reversed}" :src="require('../assets/cards/' + this.cardSpread[4].image)">  </v-img>
                <v-card-title class="font-weight-black"> {{this.cardSpread[4].name}} </v-card-title>
                <v-card-title class="font-weight-black" v-if="this.cardSpread[4].reversed"> Reversed</v-card-title>

                 
                 <v-btn  depressed color="primary" @click="replaceCard(4)"> New Card </v-btn>
                </v-card>
            </v-col>
        </v-row>
        <v-spacer></v-spacer>
...
<v-row justify="center">
    <v-col offset-md="5" cols="1">
      ...
      <v-col >
            <v-btn
            :loading ="loading"
             x large depressed color="success" @click="makeSpread"> Make Spread </v-btn>
            </v-col>
            </v-row>
...
export default {
    ...
    methods: {
        ...
        async updateStory()
        {
            ...
            this.storyTemplate[0] = this.fantastical_setting[Math.floor(Math.random()*3)] ;
           ...
           //this.storyTemplate[6] =  this.cardSpread[0].fortune_telling[Math.floor(Math.random()*this.cardSpread[0].fortune_telling.length)]
           //console.log(this.storyTemplate[6])
                
            //this.tagline = await this.getNextSentence[6]
            ...
            for (var i = 0 ; i< 5; i++)
            {
                ...
                if(reversed)
                {
                    this.storyTemplate[i+1] += card.story.shadow[tense]  + this.punctuation[this.story][i]
                }
                else{
                   this.storyTemplate[i+1] += card.story.light[tense] + this.punctuation[this.story][i]
                }
           ...
           for ( i = 0 ;  i < 6; i ++)
           {
               ...
               this.storyTelling += this.deepaiResult[i] +  this.punctuation[this.story][i]
            ...
            this.tagline = "THIS " + this.seasons[Math.floor(Math.random()*this.seasons.length)] + ", " + this.cardSpread[0].fortune_telling[Math.floor(Math.random()*this.cardSpread[0].fortune_telling.length)].toUpperCase();
        },
        ...
        makeSpread()
        {
            ...
            this.deck = JSON.parse(JSON.stringify(this.tarotData.tarot_interpretations));

            // pick a story type 
            this.story = this.storyTypes[Math.floor(Math.random()*this.storyTypes.length)];
